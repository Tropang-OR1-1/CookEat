      ...
      <section className="creators-section">
        ...
        <div className="creators-grid">
          <a href="#" className="creator-card">
            ...
            <img src="/assets/images/about_img/michael.jpeg" alt="Michael Angelo Z. Diaz" />
          ...
          <a href="https://jaygarciaaa.github.io/MySpace/" className="creator-card" target="_blank" rel="noopener noreferrer">
            <span className="ripple"></span>
            <img src="/assets/images/about_img/garcia.jpeg" alt="John Michael Garcia" />
          ...
          <a href="#" className="creator-card">
            <span className="ripple"></span>
            <img src="/assets/images/about_img/pens.jpeg" alt="John Rhey D. Peña" />
          ...
          <a href="#" className="creator-card">
            <span className="ripple"></span>
            <img src="/assets/images/about_img/ponce.jpeg" alt="Rham Ryan Ponce" />
          ...
          <a href="#" className="creator-card">
            <span className="ripple"></span>
            <img src="/assets/images/about_img/rivera.jpeg" alt="Bernie Jr. Rivera" />
          ...
          <a href="#" className="creator-card">
            <span className="ripple"></span>
            <img src="/assets/images/about_img/samarita.jpeg" alt="King Rey Mark Samarita" />
