...
function Profile({ profile, setProfile }) {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      // **NEW: Set public_id in localStorage here**
      if (response.data.Profile?.public_id) {
      ...
      if (token) {
        try {
          ...
          localStorage.setItem('public_id', decoded.public_id);  // fallback
        } catch (decodeErr) {
          ...
          <div className="tab-content-container">
            ...
            {activeTab === 'followers' && (
              <div className="followers-content">
                <Followers public_id={localStorage.getItem('public_id')} />
              </div>
            )}
          </div>
        </div>
